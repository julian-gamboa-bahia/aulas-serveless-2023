...
describe(' (get-by-id.test.ts ) deve retornar "STATUS CODE" 200 (apenas GET) e 405 caso contrario ', function () {
...
describe(' (getByIdHandler) deve retornar 405 ao receber uma solicitação com verbo diferente de GET ', function () {
